...
@Component({
  selector: 'app-db-am-dialog',
  templateUrl: './db-am-dialog.component.html',
  styleUrls: ['./db-am-dialog.component.scss']
})
export class DbAmDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRefSelf: MatDialogRef<DbAmDialogComponent>,
    private dialogRefVldReqDets: MatDialogRef<DashboardComponent>,
