...
@Component({
  selector: 'app-db-sa-dialog',
  templateUrl: './db-sa-dialog.component.html',
  styleUrls: ['./db-sa-dialog.component.scss']
})
export class DbSaDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRefSelf: MatDialogRef<DbSaDialogComponent>,
